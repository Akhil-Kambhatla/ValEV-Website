...
export function AboutTeaser() {
  return (
    <SectionWrapper bg="s3" id="about" ambientGlow="rgba(52,224,224,0.02)">
      <div className="max-w-5xl mx-auto px-6 py-20 md:py-28 flex flex-col md:flex-row md:items-center gap-10 md:gap-20">
